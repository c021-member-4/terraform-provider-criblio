...
var importMetadataBase = map[string]ResourceMetadata{
	...
	"criblio_monitor":                      {SDKService: "", ListMethod: "", GetMethod: "", ImportIDFormat: "id"},
...
var importMetadataOverrides = map[string]ResourceMetadata{
	...
	"criblio_monitor":                      {ImportIDFormat: "id", RESTListPath: "/products/lakehouse_engine_metrics/monitors", RESTGetPath: "/products/lakehouse_engine_metrics/monitors/{id}"},
